...
function birthDate() {
    ...
    if (diff.year < 13) {
        alert(`FBI: ${name} tu n'as que ${diff.year} ans, reviens quand tu auras du poil au menton !`);
        return
    }
    console.log(result);
}
...
//     if (timer > 0) {
//       timer--
//       document.getElementById("timer").innerHTML = `Rose a caché une bombe, il te reste ${timer} s afin de trouver comment la désamorcer...`
//     }
//   }
//   if(timer === 0 && !isDefuse) {
//     alert("Tu es mauvais Jack, Rose t'a détruit...")
//     isDefuse=true
//     document.getElementById("timer").innerHTML = `C'est la piquette Jack ! Tu sais pas jouer Jack ! T'es mauvais !`
...
//     let time = 120 - timer
//     document.getElementById("timer").innerHTML = `Tu as réussi à désarmorcer la bombe en  ${time} s, demande à Rose de te tenir la jambe !`
// }